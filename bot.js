...
client.on("messageDelete", (messageDelete) => {
 client.channels.get("611243996521431135").send (`**Message : "${messageDelete.content}" by ${messageDelete.author.tag}
 was deleted in channel ${message.channel.name} on server ${guild.name} at ${new Date()}.**`)
});
